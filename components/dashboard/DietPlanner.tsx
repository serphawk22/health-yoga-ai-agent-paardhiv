    ...
    return (
        <div className="relative z-10 text-zinc-100 mt-16 pb-20">
            ...
            <div className="mb-8 no-print">
                ...
                <p className="text-[0.8125rem] text-zinc-400 font-light">Get personalized nutrition recommendations</p>
            </div>
            ...
            <div className="flex bg-zinc-950/40 backdrop-blur-md p-1.5 rounded-2xl border border-white/5 mb-8 no-print w-fit shadow-xl gap-1 ring-1 ring-white/[0.03]">
                <button
                    ...
                    className={cn(
                        "px-8 py-2.5 rounded-xl text-[0.8125rem] font-normal transition-all duration-300",
                    ...
                    <div className="bg-zinc-950/40 backdrop-blur-[40px] saturate-[1.8] border border-white/[0.08] rounded-[2.5rem] p-10 shadow-[0_32px_64px_rgba(0,0,0,0.3)] no-print relative overflow-hidden group ring-1 ring-white/[0.03]">
                        ...
                        <div className="flex gap-3">
                            ...
                            {dietPlan && (
                                <button
                                    onClick={handlePrint}
                                    className="px-5 py-3 rounded-xl border border-white/10 text-[0.8125rem] font-medium text-zinc-300 hover:text-white hover:bg-white/5 transition-all"
                        ...
                        {error && (
                            <div className="mt-4 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 text-[0.8125rem]">
                                {error}
                            </div>
                        )}
                    </div>
                    ...
                    {dietPlan ? (
                        <div id="printable-content" className="space-y-6">
                            ...
                            <div className="hidden print:block mb-8 text-center">
                                <h1 className="text-[1.75rem] font-semibold text-primary-800 mb-2">Personalized Diet Plan</h1>
                                <p className="text-[0.8125rem] text-gray-600">Generated by Health Agent on {format(new Date(), 'PPP')}</p>
                            </div>
                            ...
                            <div className="bg-zinc-950/40 backdrop-blur-[40px] saturate-[1.8] border border-white/[0.08] rounded-[2.5rem] p-10 shadow-[0_32px_64px_rgba(0,0,0,0.3)] ring-1 ring-white/[0.03] print:shadow-none print:border-gray-200">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="p-5 rounded-[1.5rem] bg-orange-500/5 border border-orange-500/10 print:bg-gray-50 print:border-gray-200 ring-1 ring-orange-500/5">
                                        <p className="text-[0.8125rem] font-medium text-orange-400/80 uppercase tracking-widest mb-2 print:text-black">Daily Calories</p>
                                        <p className="text-[1.75rem] font-extralight text-white print:text-black tabular-nums tracking-tight">{dietPlan.dailyCalories}</p>
                                        <p className="text-[0.8125rem] text-zinc-400 mt-1 uppercase tracking-widest">kcal</p>
                                    </div>
                                    {dietPlan.macros && (
                                        <>
                                            <div className="p-5 rounded-[1.5rem] bg-blue-500/5 border border-blue-500/10 print:bg-gray-50 print:border-gray-200 ring-1 ring-blue-500/5">
                                                <p className="text-[0.8125rem] font-medium text-blue-400/80 uppercase tracking-widest mb-2 print:text-black">Protein</p>
                                                <p className="text-[1.75rem] font-extralight text-white print:text-black tabular-nums tracking-tight">{dietPlan.macros.protein}g</p>
                                                <p className="text-[0.8125rem] text-zinc-400 mt-1">{Math.round((dietPlan.macros.protein * 4 / dietPlan.dailyCalories) * 100)}%</p>
                                            </div>
                                            <div className="p-5 rounded-[1.5rem] bg-green-500/5 border border-green-500/10 print:bg-gray-50 print:border-gray-200 ring-1 ring-green-500/5">
                                                <p className="text-[0.8125rem] font-medium text-green-400/80 uppercase tracking-widest mb-2 print:text-black">Carbs</p>
                                                <p className="text-[1.75rem] font-extralight text-white print:text-black tabular-nums tracking-tight">{dietPlan.macros.carbs}g</p>
                                                <p className="text-[0.8125rem] text-zinc-400 mt-1">{Math.round((dietPlan.macros.carbs * 4 / dietPlan.dailyCalories) * 100)}%</p>
                                            </div>
                                            <div className="p-5 rounded-[1.5rem] bg-purple-500/5 border border-purple-500/10 print:bg-gray-50 print:border-gray-200 ring-1 ring-purple-500/5">
                                                <p className="text-[0.8125rem] font-medium text-purple-400/80 uppercase tracking-widest mb-2 print:text-black">Fats</p>
                                                <p className="text-[1.75rem] font-extralight text-white print:text-black tabular-nums tracking-tight">{dietPlan.macros.fats}g</p>
                                                <p className="text-[0.8125rem] text-zinc-400 mt-1">{Math.round((dietPlan.macros.fats * 9 / dietPlan.dailyCalories) * 100)}%</p>
                                            </div>
                                        </>
                                    )}
                                </div>
                                    ...
                                    <div className="bg-zinc-950/40 backdrop-blur-[40px] saturate-[1.8] border border-white/[0.08] rounded-[2.5rem] p-10 shadow-[0_32px_64px_rgba(0,0,0,0.3)] ring-1 ring-white/[0.03] print:shadow-none print:border-gray-200 print:break-inside-avoid">
                                        ...
                                        <ul className="space-y-3">
                                            {dietPlan.foodsToInclude.map((food: string, i: number) => (
                                                <li key={i} className="flex items-start gap-3 text-[0.8125rem] font-light text-zinc-200">
                                ...
                                <div className="bg-zinc-950/40 backdrop-blur-[40px] saturate-[1.8] border border-white/[0.08] rounded-[2.5rem] p-10 shadow-[0_32px_64px_rgba(0,0,0,0.3)] ring-1 ring-white/[0.03] print:shadow-none print:border-gray-200 print:break-inside-avoid">
                                    ...
                                    <ul className="space-y-3">
                                        {dietPlan.hydrationTips.map((tip: string, i: number) => (
                                            <li key={i} className="text-[0.8125rem] font-light text-zinc-200 flex items-start gap-3">
                            ...
                            {dietPlan.specialNotes && dietPlan.specialNotes.length > 0 && (
                                <div className="bg-amber-500/5 border border-amber-500/20 rounded-[2.5rem] p-10 ring-1 ring-amber-500/5 print:bg-transparent print:border-gray-200 print:break-inside-avoid">
                                    <p className="text-[0.8125rem] font-semibold text-amber-400 uppercase tracking-widest mb-4">Special Notes</p>
                                    <ul className="space-y-3">
                                        {dietPlan.specialNotes.map((note: string, i: number) => (
                                            <li key={i} className="text-[0.8125rem] font-light text-zinc-300 flex items-start gap-3 print:text-black">
                            ...
                            {/* Disclaimer */}
                            <div className="p-6 text-center rounded-2xl border border-white/10 text-[0.8125rem] font-light text-zinc-500 print:bg-transparent print:text-xs print:mt-10">
                        ...
                        <div className="flex flex-col items-center justify-center text-center py-20 px-6 rounded-[2.5rem] border border-white/[0.05] bg-zinc-950/20">
                            ...
                            <p className="text-[1.75rem] font-light text-zinc-300 mb-2">No plan generated yet</p>
                            <p className="text-[0.8125rem] text-zinc-500 font-light">Use the form above to create your personalized diet.</p>
                        </div>
                    )}
                </div>
            )}
                ...
                <div className="animate-fadeIn">
                    {isLoadingHistory ? (
                            ...
                            {historyItems.map((item) => (
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h4 className="font-medium text-[0.8125rem] text-white group-hover:text-primary-400 transition-colors tracking-tight mb-2">
                                                {item.title}
                                            </h4>
                                            <div className="flex items-center gap-4 text-[0.8125rem] font-light text-zinc-400">
                        ...
                        <div className="flex flex-col items-center justify-center text-center py-20 px-6 rounded-[2.5rem] border border-white/[0.05] bg-zinc-950/20">
                            ...
                            <p className="text-[1.75rem] font-light text-zinc-300 mb-2">No history found</p>
                            <p className="text-[0.8125rem] text-zinc-500 font-light">Generate a plan to save it here.</p>
                        </div>
                    )}
                </div>
            )}
    ...
    return (
        <div className={cn("p-6 rounded-[1.5rem] border ring-1 flex flex-col h-full print:border-gray-200 print:bg-transparent print:ring-0 print:break-inside-avoid", colorClass.split(' ').slice(1).join(' '))}>
            <div className="flex flex-wrap items-center justify-between gap-3 mb-5 pb-5 border-b border-white/[0.05] print:border-gray-100">
                <div>
                    <h4 className={cn("font-medium capitalize text-[0.8125rem] tracking-tight", colorClass.split(' ')[0])}>{meal.name}</h4>
                    {meal.time && (
                        <div className="flex items-center gap-1.5 mt-1.5 opacity-80">
                            ...
                            <p className="text-[0.8125rem] font-medium tracking-wider uppercase text-zinc-400">{meal.time}</p>
                        </div>
                    )}
                </div>
                {meal.calories && (
                    <div className="flex flex-col items-end">
                        <span className="text-[0.8125rem] font-medium text-zinc-500 uppercase tracking-widest mb-0.5">Energy</span>
                        <span className="text-[0.8125rem] font-light text-white tracking-tight tabular-nums bg-white/5 px-2.5 py-1 rounded-lg ring-1 ring-white/10">{meal.calories} <span className="text-[0.8125rem] text-zinc-400">kcal</span></span>
                    </div>
                )}
            </div>
            ...
            {meal.items && (
                <ul className="space-y-3 flex-grow">
                    {meal.items.map((item: string, i: number) => (
                        <li key={i} className="text-[0.8125rem] font-light text-zinc-200 leading-relaxed flex items-start gap-3 print:text-black">
